...
if argnumbers != 2 :
    ...
    print("")
    print("Usage: 'add2vals A B' where A and B are individual values.")
    print("       If add2vals is not in your path, usage is './add2vals A B'.")
    print("       If unbundled, usage is 'python add2vals.py A B'.")
    print("")
    sys.exit(1)
